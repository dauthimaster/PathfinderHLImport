...
- Many "Special Abilities" do not have a proper classification, doing a random sample, it seemed that the majority were Racial Traits, therefore 
	if you are missing a class ability, you might want to check the Racial Traits area to see if it was copied there.  This is a limitation of the xml.
...
- Cleric Domain Spells, Wizard School Specialization Spells, and other areas where Bonus Spells are gained (favored class bonuses) are not reported the xml, therefore you should
	double check to make sure that spells per day is set properly and adding Domain/Specialization/other spells.
