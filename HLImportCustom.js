...
function AddAbility(ability, value, charid) {
    createObj("ability", {
        name: ability,
    	action: value,
		characterid: charid
	...
	if (command[0] == "!import") {
        ...
        if (StatBlock.match(/<spell (.*?)<\/spell>/g) != null) {
            if (StatBlock.match(/<spell (.*?)<\/spell>/g).pop().match(/<spell (.*?)<\/spell>/g) != null) {
                // If NPC to eliminate duplicate entries, remove the <spellbook> section.
                if (CharacterRole === "npc"){
                    if (StatBlock.indexOf("<\/spellbook>") >= 0) {
                        StatBlock = StatBlock.replace(/<spellbook>(.*?)<\/spellbook>/g, "");
                    };
                };
        ...
        if (StatBlock.indexOf("<weapon ") >= 0) {
            ...
            var TotalBAB = StatBlock.match(/<attack (.*?)>/g).pop().split("baseattack='")[1].split("'", 1)[0].replace(/\+/g, "");
            ...
            for (w = 0; w < Weapons.length; w++) {
                ...
                var WeaponDamage = 0;
                var WeaponDamageAbility = "@{STR-mod}";
                var WeaponCrit = "";
                ...
                if (Damage.indexOf("+") >= 0) {
                    ...
                    WeaponDamage = parseInt(WeaponDamage) + -parseInt(WeaponEnhance) + -parseInt(StrBonus);
                } else if (Damage.indexOf("-") >=0) {
                    WeaponDamage = Damage.split("-");
                    WeaponDamage = WeaponDamage[1].replace(/\D/g, "");
                    WeaponDamage = -parseInt(WeaponDamage) + -parseInt(WeaponEnhance) + -parseInt(StrBonus);
